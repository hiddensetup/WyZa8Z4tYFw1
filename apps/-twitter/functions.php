...
function sb_twitter_subscribe() {
    $twitter = new TwitterAPIExchange(sb_get_setting('twitter'));
    $response = json_decode($twitter->setPostfields(['url' => STMBX_URL . '/apps/twitter/post.php'])->buildOauth('https://api.twitter.com/1.1/account_activity/all/sb/webhooks.json', 'POST')->performRequest(), true);
